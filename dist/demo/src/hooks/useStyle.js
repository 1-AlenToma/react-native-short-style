...
function buildNodeMeta(fullPath, parent, thisParent, type, index, total) {
    ...
    while (i >= 0) {
        ...
        const parentChildren = (_d = (_c = p === null || p === void 0 ? void 0 : p.parent) === null || _c === void 0 ? void 0 : _c.childrenPaths) !== null && _d !== void 0 ? _d : [];
        typeIndex[i] = (_f = (_e = parentChildren.find(x => x.index === indices[i] && x.type === nodeType)) === null || _e === void 0 ? void 0 : _e.typeIndex) !== null && _f !== void 0 ? _f : 0;
        totalTypes[i] = parentChildren.filter(x => x.type === nodeType).length;
        props[i] = (_g = p === null || p === void 0 ? void 0 : p.props) !== null && _g !== void 0 ? _g : {};
    ...
    const lastParentChildren = (_h = parent === null || parent === void 0 ? void 0 : parent.childrenPaths) !== null && _h !== void 0 ? _h : [];
    typeIndex[lastIdx] = (_k = (_j = lastParentChildren.find(x => x.index === index && x.type === type)) === null || _j === void 0 ? void 0 : _j.typeIndex) !== null && _k !== void 0 ? _k : 0;
    totalTypes[lastIdx] = lastParentChildren.filter(x => x.type === type).length;
    props[lastIdx] = (_l = thisParent === null || thisParent === void 0 ? void 0 : thisParent.props) !== null && _l !== void 0 ? _l : {};
...
export function useStyled(parentId, context, type, index, total, variant, thisParent, systemTheme) {
    ...
    for (const rule of context.rules) {
        for (const item of rule.parsedSelector) {
            ...
            if (typeof rule.style === "string") {
                merged = Object.assign(Object.assign({}, merged), cssTranslator(rule.style, systemTheme));
                if (merged.important)
                    important = Object.assign(Object.assign({}, important), merged.important);
    ...
    return Object.assign(Object.assign({}, merged), { important });
}
