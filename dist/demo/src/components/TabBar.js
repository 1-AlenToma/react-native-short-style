...
export class TabView extends React.PureComponent {
    render() {
        ...
        return (_jsx(View, Object.assign({}, props, { css: `fl:1 wi:100% he:100% bac-transparent ${css.c}` })));
    }
}
...
export const TabBar = (props) => {
    ...
    return (_jsx(View, { onLayout: ({ nativeEvent }) => {
            state.size = nativeEvent.layout;
        }, css: x => x.cls("_tabBar").joinRight(props.css), style: props.style, children: _jsxs(TabBarContext.Provider, { value: contextValue, children: [position === "Top" && visibleChildren.length > 1 ? (_jsx(TabBarMenu, { children: children })) : null, _jsx(AnimatedView, Object.assign({ css: `_tabBarContainer`, style: [
