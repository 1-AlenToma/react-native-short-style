...
const ScrollIsVisibleView = ({ startIndex, children }) => {
    ...
    return (_jsx(View, { ifTrue: visibility, onLayout: ({ nativeEvent }) => {
            ...
            //  validateTrigger();
        }, css: x => x.joinLeft(context.props.itemStyle).cls("virtualItemSelector"), style: style, children: children }));
};
...
const VirtualScrollerView = React.memo(({ startIndex }) => {
    ...
    return (_jsx(ScrollIsVisibleView, { startIndex: startIndex, children: renderedItems }));
});
