...
import { CheckBox, CheckBoxList, DropdownList, FormItem, TextInput, FormGroup, useLocalMemo } from "react-native-short-style"
...
//countries = Array.from({ length: 3000 }).map((x, i) => ({ label: "namn " + i, value: i }))
