...
export const PlatformStyleSheet = () => {
    ...
    return cachedCss[Platform.OS] ?? (cachedCss[Platform.OS] = Platform.OS == "web" ? NestedStyleSheet.create({
        ...
        "_buttonGroupButton:last-child": x => x.boRW(0),
        ...
        "_toast>View:eq(0)": x => x.fl(1).fillView().flD("row").cls("_center").baC("$co-transparent").importantValue(),
        ...
        _formGroup: "flg-1 maw:90% ali-center mab-25",
         "_formGroup>View:eq(1)": "bor:5 bow:.5 boc:gray _center ma:5 fld-row _overflow wi-100% he-100% bac-red",
