            ...
            <View css="_tabBarContainerView">
                {menuItems.map((x, i) => (
                    <TouchableOpacity
                        ...
                        {x.props.title ? (
                            <Text
                                style={[{ ...menuText }, state.selectedIndex == i ? header?.selectedTextStyle.o : null]}
                                css={`fos-sm ${state.selectedIndex == i ? header?.selectedTextStyle.o : ""}`}>
                                {x.props.title}
                            </Text>
                        ) : null}
                    </TouchableOpacity>
        ...
        <View onLayout={({ nativeEvent }) => {
            ...
            <TabBarContext.Provider value={contextValue}>
                ...
                <AnimatedView
                    ...
                    {children.map((x, i) => (
                        <View
                            css={x => x.flG(1).baC("$co-transparent").maW(state.size.width)}
                            key={i}>
                            {x.props.head}
