...
export declare abstract class ExtraCssStyle {
  ...
  -----------------
    ...
    */
    ...
    joinLeft(value: CSSStyle | string | ViewStyle | ImageStyle | TextStyle | ((x: CSSStyle) => CSSStyle)): this;
    joinRight(value: CSSStyle | string | ViewStyle | ImageStyle | TextStyle | ((x: CSSStyle) => CSSStyle)): this;
}
export declare class CSSStyle extends ExtraCssStyle {
    ...
    /** Add display */
    di(value?: ValueType["display"] | null): this;
...
export declare class CSSStyleSheetStyle extends CSSStyle {
    private eqs;
    important(): this;
    child(indexOrClassOrViewName: (number | "last" | (string & {})), css: ((x: CSSStyleSheetStyle) => CSSStyleSheetStyle) | string): this;
    /** Used in NestedStyleSheet */
    getEqs(parentKey: any, item?: CSSStyleSheetStyle): {
        key: string;
        css: string;
    }[];
    props<T extends object>(props: Omit<CSSProps<T>, "ref">): this;
}
export {};
