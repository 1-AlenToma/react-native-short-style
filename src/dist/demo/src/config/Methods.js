...
export const readAble = function (nr, total) {
    var _a;
    if (Array.isArray(nr))
        nr = nr[0];
    ...
    if (nrs.length <= 1)
        return nr;
    return parseFloat(nr === null || nr === void 0 ? void 0 : nr.toFixed(total !== null && total !== void 0 ? total : 2));
};
...
export const currentTheme = (context) => {
    ...
    return Object.assign(Object.assign(Object.assign({}, thisTheme), selectedTheme), ComponentsStyles);
};
...
export const refCreator = function (forwardRef, name, view) {
    ...
    forwardRef.name = `StyledItem(${name})`;
