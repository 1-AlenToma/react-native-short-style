...
export class TabView extends React.PureComponent {
    render() {
        ...
        return (React.createElement(View, Object.assign({}, props, { css: `fl:1 wi:100% he:100% bac-transparent ${css.c}` })));
    }
}
...
const TabBarMenu = ({ children }) => {
    ...
    const getIcon = (icon, style, index) => {
        ...
        return (React.createElement(IconView, Object.assign({}, iconProps, icon.props, { style: propStyle, css: css })));
    };
    if (menuItems.length <= 1)
        return null; // its a single View no need to display Menu Header;
    let border = (React.createElement(AnimatedView, { css: header.overlayStyle.container.c, style: [
            {
            ...
            header.overlayStyle.container.o,
            {
                ...
                borderRadius: 2,
                height: 3,
                width: (_m = (_l = state.manuItemSize) === null || _l === void 0 ? void 0 : _l.width) !== null && _m !== void 0 ? _m : 0,
                transform: [
                    {
        ...
        React.createElement(View, { onStartShouldSetResponder: event => false, onTouchStart: e => {
                context.onMenuChange(state.selectedIndex);
            }, style: [
                header.overlayStyle.content.o,
                {
                    width: (_o = state.manuItemSize) === null || _o === void 0 ? void 0 : _o.width,
                    height: (_p = state.manuItemSize) === null || _p === void 0 ? void 0 : _p.height
                },
                position != "Top"
                    ? { bottom: -((_r = (_q = state.manuItemSize) === null || _q === void 0 ? void 0 : _q.height) !== null && _r !== void 0 ? _r : 0) }
                    : { top: -((_t = (_s = state.manuItemSize) === null || _s === void 0 ? void 0 : _s.height) !== null && _t !== void 0 ? _t : 0) }
    ...
    return (React.createElement(View, { css: x => x.cls("_tabBarMenu").if(position == "Bottom", x => x.boTC("$co-gray300").boTW(.5), x => x.boBC("$co-gray300").boBW(.5)).joinRight(header.style.c), style: [header.style.o] },
        position != "Top" ? border : null,
        React.createElement(View, { css: "_tabBarContainerView bac-transparent" }, menuItems.map((x, i) => (React.createElement(TouchableOpacity, { onLayout: event => {
            ...
            x.props.icon ? getIcon(x.props.icon, Object.assign(Object.assign({}, menuText), { height: i == state.selectedIndex ? 15 : 18, fontSize: i == state.selectedIndex ? 15 : 18 }), i) : null,
            x.props.title ? (React.createElement(Text, { style: [Object.assign({}, menuText), header.textStyle.o, state.selectedIndex == i ? header === null || header === void 0 ? void 0 : header.selectedTextStyle.o : null], css: `fos-sm ${state.selectedIndex == i ? header === null || header === void 0 ? void 0 : header.selectedTextStyle.o : ""} ${header.textStyle.c}` }, x.props.title)) : null)))),
        position == "Top" ? border : null));
};
export const TabBar = (props) => {
    ...
    const state = StateBuilder({
        size: { width: globalData.window.width, height: globalData.window.height },
        index: (_c = props.selectedTabIndex) !== null && _c !== void 0 ? _c : 0,
        refItem: {
    ...
    const getWidth = (index) => {
        var _a;
        let v = index * ((_a = state.size.width) !== null && _a !== void 0 ? _a : globalData.window.width);
        if (isNaN(v))
            return 0;
        return v;
    };
    ...
    const getView = (index, view) => {
        if (props.lazyLoading && !state.refItem.loadedViews[index])
            return (React.createElement(Loader, { loading: true, text: props.loadingText }));
        return view;
    };
    React.useEffect(() => {
        var _a;
    ...
    const contextValue = {
        ...
        props: props,
        lazyLoading: (_d = props.lazyLoading) !== null && _d !== void 0 ? _d : false,
        selectedIndex: (_e = state.index) !== null && _e !== void 0 ? _e : 0,
        size: state.size,
        animated: menuAnimation.animate
    };
    return (React.createElement(View, { onLayout: ({ nativeEvent }) => {
            state.size = nativeEvent.layout;
        }, css: x => x.cls("_tabBar").joinRight(props.css), style: props.style },
        React.createElement(TabBarContext.Provider, { value: contextValue },
            position === "Top" && visibleChildren.length > 1 ? (React.createElement(TabBarMenu, { children: children })) : null,
            React.createElement(AnimatedView, Object.assign({ css: `_tabBarContainer`, style: [
                ...
                ] }, state.refItem.panResponse.panHandlers), children.map((x, i) => (React.createElement(View, { style: {
                ...
                x.props.head,
                !props.disableScrolling && !x.props.disableScrolling ? (React.createElement(ScrollView, { style: {
                        width: "100%",
                    }, contentContainerStyle: {
                        flexGrow: 1,
                        width: "100%",
                        maxWidth: "100%"
                    } }, getView(i, x))) : (getView(i, x)))))),
            position !== "Top" && visibleChildren.length > 1 ? (React.createElement(TabBarMenu, { children: children })) : null,
            props.footer)));
};
