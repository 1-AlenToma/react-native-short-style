...
export const Button = (props) => {
    ...
    return (React.createElement(TouchableOpacity, Object.assign({}, pressableProps, { onMouseLeave: onMouseLeave, onMouseEnter: onMouseEnter, css: x => x.cls(shadow, "_button button").joinRight(props.css).if(disabled, x => x.cls("disabled")) }),
        props.icon,
        React.createElement(Text, { ifTrue: props.text != undefined, css: x => x.cls("fos-xs").joinRight(props.textCss) }, props.text)));
};
