...
import { newId, clearAllCss, useCurrentTheme } from "../config";
...
function useParseStyles(obj: Record<string, any>, selectedIndex: number): Rule[] {
...
export const ThemeContainer = (props: IThemeContext & { children: any }) => {
    ...
    const theme = useCurrentTheme(props);
