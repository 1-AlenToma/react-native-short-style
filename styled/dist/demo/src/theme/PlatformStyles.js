...
const userStyle = NestedStyleSheet.create({
    ...
    "selectedValue, selectedValue > *": x => x.baC("#007fff").co("#FFFFFF").importantAll(),
...
export const PlatformStyleSheet = () => {
    return cachedCss[Platform.OS] ?? (cachedCss[Platform.OS] = Platform.OS == "web" ? NestedStyleSheet.create({
        ...
        _formItemCenterLeft: x => x.miH(40).alI("center"),
        ...
        _buttonGroupButton: x => x.boRW(.5).cls("_center").boC(".co-gray400").pa(5).he("100%").cls("_overflow"),
        "View > _buttonGroupButton:last-child": x => x.boRW(0),
        ...
        "_button>Text, _button >Icon ": x => x.maL(0),
        "_button>Text": x => x.paL(2),
        _slider: x => x.di("flex").flD("row").juC("space-between").alI("center").wi("100%").miH(40),
        _sliderThump: ".fos-sm mal:-37% bor:5 fow:bold mat:-35px bow:1 boc:#CCC miw:50 pat:2 pab:2 tea:center zi:100 ._center",
        _sliderButton: x => x.size(30, 30).cls("_center").pa(0).maW(30).fl(1).maL(5),
        "_sliderButton>*:eq(0)": c => c.maR(0).maL(0),
        ...
        "_toast>View:eq-of-type(0)": x => x.fl(1).fillView().flD("row").cls("_center").baC(".co-transparent").importantValue(),
        ...
        "_formGroup>View:eq(1)": "bor:5 bow:.5 boc:gray _center ma:5 fld-row _overflow wi-100% he-100% !important",
        ...
        "_button>Text": x => x.paL(2),
        _slider: x => x.di("flex").flD("row").juC("space-between").alI("center").wi("100%").miH(40),
        _sliderThump: "_abc to:-35 le:-15 fos-sm bor:5 fow:bold bow:1 boc:#CCC miw:50 pat:2 pab:2 tea:center zi:100 ._center",
        _sliderButton: x => x.size(30, 30).cls("_center").pa(0).maW(30).fl(1).maL(5),
        "_sliderButton>*:eq(0)": c => c.maR(5).maL(0),
        _modalClose: x => x.cls("_abc").he(30).wi(30).ri(4).to(4).zI(3).alI("flex-end").baC(".co-transparent"),
        _modal: x => x.wi("80%"),
