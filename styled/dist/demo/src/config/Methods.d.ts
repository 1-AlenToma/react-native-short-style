import { AlertViewAlertProps, AlertViewProps, IThemeContext, Size, ToastProps } from "../Typse";
import React from "react";
import { View } from "react-native";
export declare const measure: (item: View) => Promise<Size>;
export declare const toArray: (item: any) => any[];
...
export declare const refCreator: <T>(useMem: boolean, forwardRef: (props: any, ref: any) => React.ReactNode, name: string, view: any, compare?: (prevProps: any, nextProps: any) => boolean) => T;
