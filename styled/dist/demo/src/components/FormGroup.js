...
export const FormItem = (props) => {
    ...
    const css = "mar:5";
    return (_jsxs(View, { style: props.style, css: memo(() => x => x.cls("_formItem", "FormItem").joinRight(props.css), props.css), children: [_jsxs(View, { css: memo(() => x => x.flD(labelPosition == "Top" ? "column" : "row").if(labelPosition == "Top", "ali-flex-start", "ali-center juc-space-between"), props.css), children: [_jsxs(View, { css: "fld-row", children: [_jsx(View, { ifTrue: icon != undefined, css: memo(() => x => x.maW(20).joinRight(css), props.css), children: icon && icon.type ? _jsx(Icon, { size: 15, color: "white", ...icon }) : icon }), _jsx(View, { ifTrue: props.title != undefined, css: css, children: props.title && typeof props.title == "string" ? _jsx(Text, { css: ".fos-sm fow:bold", children: props.title }) : props.title }), _jsx(ToolTip, { postion: "Top", containerStyle: "po:relative le:1", ifTrue: props.info != undefined && labelPosition == "Top", text: props.info, children: props.infoIcon ? (props.infoIcon) : (_jsx(Icon, { type: "FontAwesome", name: "info-circle", size: 15 })) })] }), _jsx(View, { css: memo(() => x => x.cls("_formItemCenter", "_formItemCenter" + labelPosition).if(labelPosition == "Top", x => x.wi("100%")), labelPosition), children: props.children }), _jsx(ToolTip, { postion: "Top", containerStyle: "po:relative le:1", ifTrue: props.info != undefined && labelPosition != "Top", text: props.info, children: props.infoIcon ? (props.infoIcon) : (_jsx(Icon, { type: "FontAwesome", name: "info-circle", size: 15 })) })] }), _jsx(View, { ifTrue: props.message != undefined, css: "fl:1 pal:10 pab:5", children: props.message })] }));
};
export const FormGroup = (props) => {
    const { mem } = useLocalMemo();
    return (_jsx(ForGroupContext.Provider, { value: mem({ labelPosition: props.labelPosition }, props.labelPosition), children: _jsxs(View, { style: props.style, css: mem(x => x.cls("_formGroup FormGroup").maT(30).joinRight(props.css), props.css), children: [_jsx(View, { ifTrue: props.title != undefined && props.formStyle == "Headless", css: "headerLine", children: _jsx(View, { css: "bac-transparent", children: _jsx(Text, { numberOfLines: 1, children: props.title }) }) }), _jsx(View, { css: "bac-transparent", children: _jsxs(View, { css: "bac-transparent", children: [_jsx(View, { ifTrue: props.title != undefined && props.formStyle != "Headless", css: "wi-100% fl-0 flg-1 pa-5 header bac-transparent", children: _jsx(Text, { css: "bac-transparent", numberOfLines: 1, children: props.title }) }), _jsx(View, { css: mem(x => x.maT(8).fillView().flG(1).paL(5).paR(5).baC(".co-transparent")), children: props.children })] }) })] }) }));
};
