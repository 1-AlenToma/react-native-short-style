...
export declare const View: Omit<Native.View, "ref" | "props"> & {
...
export declare const Slider: Omit<NativeSlider.Slider, "ref" | "props"> & {
...
export declare const Text: Omit<Native.Text, "ref" | "props"> & {
...
export declare const TextInput: Omit<Native.TextInput, "ref" | "props"> & {
...
export declare const ScrollView: Omit<Native.ScrollView, "ref" | "props"> & {
...
export declare const FlatList: Omit<Native.FlatList<any>, "ref" | "props"> & {
...
export declare const TouchableOpacity: Omit<React.ForwardRefExoticComponent<Native.TouchableOpacityProps & React.RefAttributes<Native.View>>, "ref" | "props"> & {
...
export declare const TouchableWithoutFeedback: Omit<Native.TouchableWithoutFeedback, "ref" | "props"> & {
...
export declare const TouchableNativeFeedback: Omit<Native.TouchableNativeFeedback, "ref" | "props"> & {
...
export declare const Image: Omit<Native.Image, "ref" | "props"> & {
...
export declare const AnimatedView: Omit<Native.View, "ref" | "props"> & {
    props: GenericViewProps<Native.View, Native.ViewProps>;
} & ((props: GenericViewProps<Native.View, Omit<Native.ViewProps, "style">>) => React.ReactElement<Native.ViewProps, string | React.JSXElementConstructor<any>>);
export declare const AnimatedText: Omit<Native.Text, "ref" | "props"> & {
    props: GenericViewProps<Native.Text, Native.TextProps>;
} & ((props: GenericViewProps<Native.Text, Omit<Native.TextProps, "style">>) => React.ReactElement<Native.TextProps, string | React.JSXElementConstructor<any>>);
export declare const AnimatedTouchableOpacity: Omit<React.ForwardRefExoticComponent<Native.TouchableOpacityProps & React.RefAttributes<Native.View>>, "ref" | "props"> & {
    props: GenericViewProps<React.ForwardRefExoticComponent<Native.TouchableOpacityProps & React.RefAttributes<Native.View>>, Native.TouchableOpacityProps>;
} & ((props: GenericViewProps<React.ForwardRefExoticComponent<Native.TouchableOpacityProps & React.RefAttributes<Native.View>>, Omit<Native.TouchableOpacityProps, "style">>) => React.ReactElement<Native.TouchableOpacityProps, string | React.JSXElementConstructor<any>>);
export declare const AnimatedScrollView: Omit<Native.ScrollView, "ref" | "props"> & {
    props: GenericViewProps<Native.ScrollView, Native.ScrollViewProps>;
} & ((props: GenericViewProps<Native.ScrollView, Omit<Native.ScrollViewProps, "style">>) => React.ReactElement<Native.ScrollViewProps, string | React.JSXElementConstructor<any>>);
