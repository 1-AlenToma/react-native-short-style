...
export const useLoader = (initValue, text) => {
    const [loading, setLoading] = useState(initValue ?? false);
    ...
    let elem = !loading ? null : (_jsxs(View, { css: "_loader", children: [_jsx(View, {}), _jsx(ActivityIndicator, { size: "large", style: {
                    zIndex: 2
                } }), _jsx(ProgressBar, { css: "he-100%", ifTrue: (progressValue ?? 0) > 0, value: progressValue / 100, children: _jsxs(Text, { children: [readAble(progressValue ?? 0), "%"] }) }), _jsx(Text, { ifTrue: text != undefined, css: "_title", children: text })] }));
