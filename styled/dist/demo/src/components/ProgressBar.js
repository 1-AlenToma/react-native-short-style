...
export const ProgressBar = ({ value, ifTrue, color, speed, css, style, children }) => {
    ...
    return (_jsxs(View, { ifTrue: ifTrue, onLayout: e => {
            setSize(e.nativeEvent.layout);
        }, style: style, css: x => x.cls("_progressBar").joinRight(css), children: [_jsx(Blur, { css: "zi:1" }), _jsx(View, { css: "zi:3 bac:transparent wi-100% juc-center ali-center fld-row", children: children }), _jsx(AnimatedView, { css: "_progressBarAnimatedView", style: {
